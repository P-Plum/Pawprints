...

{
	...
	public static void init()
	{
		...
		GameRegistry.addSmelting(new ItemStack(ItemInit.PACA_THIGH), new ItemStack(ItemInit.PACA_THIGH_COOKED), 0.35F);
		GameRegistry.addSmelting(new ItemStack(ItemInit.CATERPILLAR), new ItemStack(ItemInit.CRISPY_CATERPILLAR), 0.25F);
		GameRegistry.addSmelting(new ItemStack(ItemInit.RAWCRAB), new ItemStack(ItemInit.COOKEDCRAB), 0.25F);
	}
