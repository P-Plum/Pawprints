...
public class ModelPussMoth extends ModelBase {
	...
	public ModelPussMoth() {
		...
		body.addChild(butt);
		setRotationAngle(butt, 0.4189F, 0.0F, 0.0F);
		butt.cubeList.add(new ModelBox(butt, 11, 13, -1.5F, -1.5F, -0.5F, 3, 3, 5, -0.1F, false));

		tail = new ModelRenderer(this);
		tail.setRotationPoint(0.0F, -0.1104F, 2.7921F);
		butt.addChild(tail);
		setRotationAngle(tail, -0.7505F, 0.0F, 0.0F);
