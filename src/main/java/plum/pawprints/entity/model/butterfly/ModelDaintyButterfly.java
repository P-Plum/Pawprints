...
public class ModelDaintyButterfly extends ModelBase {
	...
	public ModelDaintyButterfly() {
		...
		headplaneright.cubeList.add(new ModelBox(headplaneright, 0, 21, -1.0F, -1.0F, -2.0F, 0, 2, 3, 0.0F, false));
		...
		tail10.setRotationPoint(0.0F, -1.2968F, -2.7397F);
		head.addChild(tail10);
		setRotationAngle(tail10, -0.7679F, 0.0F, 0.0F);
		tail10.cubeList.add(new ModelBox(tail10, 26, 7, -1.0F, -2.0F, 1.0F, 2, 2, 0, 0.0F, false));

		tail = new ModelRenderer(this);
		tail.setRotationPoint(0.0F, -1.7F, 4.4F);
		body.addChild(tail);
		setRotationAngle(tail, -0.6283F, 0.0F, 0.0F);
		tail.cubeList.add(new ModelBox(tail, 26, 5, -1.0F, -2.0F, 1.0F, 2, 2, 0, 0.0F, false));

		tail5 = new ModelRenderer(this);
		tail5.setRotationPoint(0.0F, -1.7F, 2.8F);
		body.addChild(tail5);
		setRotationAngle(tail5, -0.6283F, 0.0F, 0.0F);
		tail5.cubeList.add(new ModelBox(tail5, 26, 0, -1.0F, -2.0F, 1.0F, 2, 2, 0, 0.0F, false));

		tail6 = new ModelRenderer(this);
		tail6.setRotationPoint(0.0F, -1.7F, 1.2F);
		body.addChild(tail6);
		setRotationAngle(tail6, -0.6283F, 0.0F, 0.0F);
		tail6.cubeList.add(new ModelBox(tail6, 26, 26, -1.0F, -2.0F, 1.0F, 2, 2, 0, 0.0F, false));

		tail7 = new ModelRenderer(this);
		tail7.setRotationPoint(0.0F, -1.6F, -0.3F);
		body.addChild(tail7);
		setRotationAngle(tail7, -0.6283F, 0.0F, 0.0F);
		tail7.cubeList.add(new ModelBox(tail7, 13, 26, -1.0F, -2.0F, 1.0F, 2, 2, 0, 0.0F, false));

		tail8 = new ModelRenderer(this);
		tail8.setRotationPoint(0.0F, -1.6F, -2.0F);
		body.addChild(tail8);
		setRotationAngle(tail8, -0.6283F, 0.0F, 0.0F);
		tail8.cubeList.add(new ModelBox(tail8, 9, 26, -1.0F, -2.0F, 1.0F, 2, 2, 0, 0.0F, false));

		tail9 = new ModelRenderer(this);
		tail9.setRotationPoint(0.0F, -1.7F, -3.4F);
		body.addChild(tail9);
		setRotationAngle(tail9, -0.6283F, 0.0F, 0.0F);
		tail9.cubeList.add(new ModelBox(tail9, 0, 26, -1.0F, -2.0F, 1.0F, 2, 2, 0, 0.0F, false));

		tail2 = new ModelRenderer(this);
		tail2.setRotationPoint(0.0F, -2.0F, -7.6F);
		body.addChild(tail2);
		setRotationAngle(tail2, -0.6283F, 0.0F, 0.0F);
		tail2.cubeList.add(new ModelBox(tail2, 25, 21, -1.0F, -2.0F, 1.0F, 2, 2, 0, 0.0F, false));

		tail3 = new ModelRenderer(this);
		tail3.setRotationPoint(0.0F, -1.8F, -6.1F);
		body.addChild(tail3);
		setRotationAngle(tail3, -0.6283F, 0.0F, 0.0F);
		tail3.cubeList.add(new ModelBox(tail3, 16, 21, -1.0F, -2.0F, 1.0F, 2, 2, 0, 0.0F, false));

		tail4 = new ModelRenderer(this);
		tail4.setRotationPoint(0.0F, -1.8F, -4.7F);
		body.addChild(tail4);
		setRotationAngle(tail4, -0.6283F, 0.0F, 0.0F);
		tail4.cubeList.add(new ModelBox(tail4, 0, 13, -1.0F, -2.0F, 1.0F, 2, 2, 0, 0.0F, false));
		...
		butterfly.cubeList.add(new ModelBox(butterfly, 9, 21, -1.0F, -1.0F, -2.8F, 2, 2, 3, -0.2F, false));
		...
		abdomen.cubeList.add(new ModelBox(abdomen, 0, 0, -2.0F, -2.0F, -1.0F, 4, 4, 6, -0.9F, false));

		head2 = new ModelRenderer(this);
		head2.setRotationPoint(0.0F, -0.2F, -3.2F);
		butterfly.addChild(head2);
		setRotationAngle(head2, 0.1047F, 0.0F, 0.0F);
		head2.cubeList.add(new ModelBox(head2, 19, 21, -1.0F, -1.0F, -1.0F, 2, 2, 2, -0.3F, false));
		...
		antennae.cubeList.add(new ModelBox(antennae, 9, 0, -2.0F, 0.0F, -5.0F, 4, 0, 5, 0.0F, false));
		...
		wingleft.cubeList.add(new ModelBox(wingleft, 32, 32, 0.0F, -0.5F, -15.7F, 16, 0, 34, 0.0F, false));
