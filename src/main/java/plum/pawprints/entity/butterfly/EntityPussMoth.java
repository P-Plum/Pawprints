...
public class EntityPussMoth extends EntityButterfly implements IAnimatable
{	
	public AnimationFactory factory = new AnimationFactory(this);
	private BlockPos spawnPosition;
	
	public EntityPussMoth(World worldIn)
	{
		super(worldIn);
	...
	public EntityAgeable createChild(EntityAgeable ageable) {
		EntityPussMoth child = new EntityPussMoth(this.world);
		return child;
	}
    ...
    {
        data.addAnimationController(new AnimationController<EntityPussMoth>(this, "controller", 0, this::predicate));
    }
