...
public class EntityRegalMoth extends EntityButterfly implements IAnimatable
{	
    ...
    {
        data.addAnimationController(new AnimationController<EntityRegalMoth>(this, "controller", 0, this::predicate));
    }
