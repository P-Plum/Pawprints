...
public class EntityLunaMoth extends EntityButterfly implements IAnimatable
{	
    ...
    {
        data.addAnimationController(new AnimationController<EntityLunaMoth>(this, "controller", 0, this::predicate));
    }
