...
public class EntityDaintyButterfly extends EntityButterfly implements IAnimatable
{	
	public AnimationFactory factory = new AnimationFactory(this);
	private BlockPos spawnPosition;
	
	public EntityDaintyButterfly(World worldIn)
	{
		super(worldIn);
	...
	public EntityAgeable createChild(EntityAgeable ageable) {
		EntityDaintyButterfly child = new EntityDaintyButterfly(this.world);
		return child;
	}
    ...
    {
        data.addAnimationController(new AnimationController<EntityDaintyButterfly>(this, "controller", 0, this::predicate));
    }
