...
public class EntityMadagascanMoth extends EntityButterfly implements IAnimatable
{	
	public AnimationFactory factory = new AnimationFactory(this);
	private BlockPos spawnPosition;
	
	public EntityMadagascanMoth(World worldIn)
	{
		super(worldIn);
	...
	public EntityAgeable createChild(EntityAgeable ageable) {
		EntityMadagascanMoth child = new EntityMadagascanMoth(this.world);
		return child;
	}
    ...
    {
        data.addAnimationController(new AnimationController<EntityMadagascanMoth>(this, "controller", 0, this::predicate));
    }
