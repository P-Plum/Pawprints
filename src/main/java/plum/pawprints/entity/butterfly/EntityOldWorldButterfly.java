...
public class EntityOldWorldButterfly extends EntityButterfly implements IAnimatable
{	
	public AnimationFactory factory = new AnimationFactory(this);
	private BlockPos spawnPosition;
	
	public EntityOldWorldButterfly(World worldIn)
	{
		super(worldIn);
	...
	public EntityAgeable createChild(EntityAgeable ageable) {
		EntityOldWorldButterfly child = new EntityOldWorldButterfly(this.world);
		return child;
	}
    ...
    {
        data.addAnimationController(new AnimationController<EntityOldWorldButterfly>(this, "controller", 0, this::predicate));
    }
