...
public class EntityDeathsHeadMoth extends EntityButterfly implements IAnimatable
{	
	public AnimationFactory factory = new AnimationFactory(this);
	private BlockPos spawnPosition;
	
	public EntityDeathsHeadMoth(World worldIn)
	{
		super(worldIn);
	...
	public EntityAgeable createChild(EntityAgeable ageable) {
		EntityDeathsHeadMoth child = new EntityDeathsHeadMoth(this.world);
		return child;
	}
    ...
    {
        data.addAnimationController(new AnimationController<EntityDeathsHeadMoth>(this, "controller", 0, this::predicate));
    }
