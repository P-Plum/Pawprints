...
{	
	...
	private static final DataParameter<Byte> CLIMBING = EntityDataManager.<Byte>createKey(EntityNudibranchAnnulata.class, DataSerializers.BYTE);
    ...
    {
        EntityLiving.registerFixesMob(fixer, EntityNudibranchAnnulata.class);
    }
