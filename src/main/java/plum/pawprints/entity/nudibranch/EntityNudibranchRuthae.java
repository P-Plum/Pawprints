...
{	
	...
	private static final DataParameter<Byte> CLIMBING = EntityDataManager.<Byte>createKey(EntityNudibranchRuthae.class, DataSerializers.BYTE);
    ...
    {
        EntityLiving.registerFixesMob(fixer, EntityNudibranchRuthae.class);
    }
