...
public class BlockCapeReed extends BlockBase implements IPlantable {
	
	public static final PropertyDirection FACING = BlockHorizontal.FACING;
	
	public static final AxisAlignedBB CAPEREED_AABB = new AxisAlignedBB(0, 0, 0, 1D, 2D, 1D);
	public static final Block block = null;

	public BlockCapeReed(String name) {
	...
	{
		return CAPEREED_AABB;
	}
	
	public ItemStack getItem(World worldIn, BlockPos pos, IBlockState state)
    {
        return new ItemStack(BlockInit.CAPEREED);
    }
	...
	public boolean canPlaceBlockAt(World worldIn, BlockPos pos)
    {
        ...
        else if (block != Blocks.GRASS && block != Blocks.DIRT && block != Blocks.GRAVEL && block != Blocks.SAND)
        {
            return false;
        }
        else
