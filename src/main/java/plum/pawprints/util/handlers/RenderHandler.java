...
import plum.pawprints.entity.render.RenderSeriema;
import plum.pawprints.entity.render.RenderTenrec;
import plum.pawprints.entity.render.RenderTermite;
import plum.pawprints.entity.render.RenderVinegaroon;
import plum.pawprints.entity.render.butterfly.RenderDaintyButterfly;
import plum.pawprints.entity.render.butterfly.RenderDeathsHeadMoth;
import plum.pawprints.entity.render.butterfly.RenderLunaMoth;
import plum.pawprints.entity.render.butterfly.RenderMadagascanMoth;
...
import plum.pawprints.entity.render.butterfly.RenderRegalMoth;
...
public class RenderHandler
{
	public static void registerEntityRenders()
	{
		...
		RenderingRegistry.registerEntityRenderingHandler(EntitySeriema.class, RenderSeriema::new);
		...
		RenderingRegistry.registerEntityRenderingHandler(EntityDeathsHeadMoth.class, RenderDeathsHeadMoth::new);
		RenderingRegistry.registerEntityRenderingHandler(EntityLunaMoth.class, RenderLunaMoth::new);
		RenderingRegistry.registerEntityRenderingHandler(EntityMadagascanMoth.class, RenderMadagascanMoth::new);
		RenderingRegistry.registerEntityRenderingHandler(EntityPussMoth.class, RenderPussMoth::new);
		RenderingRegistry.registerEntityRenderingHandler(EntityRegalMoth.class, RenderRegalMoth::new);
