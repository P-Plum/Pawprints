...
public class EntityContainer {
	...
	/*
	 * This code has been picked from Better Animals Plus created by cybercat5555, itsmeow and Batpixxler.
	 * No infringement is intended.
	 * According to Creative Commons Attribution-NonCommercial-ShareAlike 4.0 International (CC BY-NC-SA 4.0), this code is allowed to be copied and redistribute the material in any medium or format.
	 * */
